...
/**
 * 商品編集画面の在庫数グラフを表示する為に必要な、商品名と在庫数と備考をD3GraphListに格納するアクションクラス
 * @author Yuki Hoshino
 * @version 1.0
 * @since 1.0
 */
public class SelectItemStockListAction extends ActionSupport{
	...
	/**
	 * 商品名と在庫数と備考をD3GraphListに格納するメソッド
	 * @return result SUCCESSをresultに格納します。もし必要な商品名と在庫数と備考が受け取れなければresultにERRORを格納しresultを返します。受け取れればD3GraphListに値を格納、resultを返します。
	 */
